## This is Digilent's general .xdc for the Arty A7-100 Rev. D and Rev. E,
## with the four pins this design actually uses uncommented and renamed to
## uart_loopback_top's real port names (clk, reset_n, rx_pin_i, tx_pin_o) --
## everything else is left as the original commented-out template for
## reference if this design ever needs more board I/O.
##
## IMPORTANT: verify these package pins against your own Arty A7 board files
## (Digilent's "Arty-A7-100-Master.xdc") before generating a bitstream.

## Clock signal
set_property -dict {PACKAGE_PIN E3 IOSTANDARD LVCMOS33} [get_ports clk]
create_clock -period 10.000 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports clk]

## Switches -- sw[0] used here as reset_n (board pull-up: '1' = running, '0' = held in reset)
set_property -dict {PACKAGE_PIN A8 IOSTANDARD LVCMOS33} [get_ports reset_n]
...
## USB-UART Interface
## uart_rxd_out (what the USB-UART bridge receives, i.e. what this FPGA
## transmits) -> tx_pin_o. uart_txd_in (what the bridge sends in, i.e. what
## this FPGA receives) -> rx_pin_i.
set_property -dict {PACKAGE_PIN D10 IOSTANDARD LVCMOS33} [get_ports tx_pin_o]
set_property -dict {PACKAGE_PIN A9 IOSTANDARD LVCMOS33} [get_ports rx_pin_i]
